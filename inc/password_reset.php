<?php
/**
 * MENSAJE DEL CUERPO DEL CORREO QUE LUEGO SERA ENVIADOD
 */
...
class password_reset_mensaje {
  ...
  <html xmlns="http://www.w3.org/1999/xhtml" xmlns="http://www.w3.org/1999/xhtml">
    <head>
      ...
      <title>Configurar una nueva contraseña para TRIBU CUEROS</title>
                  ...
                  <table class="email-body_inner" align="center" width="570" cellpadding="0" cellspacing="0" style="box-sizing: border-box; font-family: Arial, '.'Helvetica Neue'.', Helvetica, sans-serif; margin: 0 auto; padding: 0; width: 570px;" bgcolor="#FFFFFF">
                    ...
                    <tr>
                      <td class="content-cell" style="box-sizing: border-box; font-family: Arial, '.'Helvetica Neue'.', Helvetica, sans-serif; padding: 35px; word-break: break-word;">
                        <h1 style="box-sizing: border-box; color: #2F3133; font-family: Arial, '.'Helvetica Neue'.', Helvetica, sans-serif; font-size: 19px; font-weight: bold; margin-top: 0;" align="center">Hola</h1>
...
private $SegundaPartmensaje ='" </h2>
                                    ...
                                    <table border="0" cellspacing="0" cellpadding="0" style="box-sizing: border-box; font-family: Arial, '.'Helvetica Neue'.', Helvetica, sans-serif;">
                                      <tr>
                                        <td style="box-sizing: border-box; font-family: Arial, '.'Helvetica Neue'.', Helvetica, sans-serif; word-break: break-word;">
                                          <a href="http://newweb.tribucueros.com.ar/change_password.php" class="button button--green" target="_blank" style="-webkit-text-size-adjust: none; background: #22BC66; border-color: #22bc66; border-radius: 3px; border-style: solid; border-width: 10px 18px; box-shadow: 0 2px 3px rgba(0, 0, 0, 0.16); box-sizing: border-box; color: #FFF; display: inline-block; font-family: Arial, '.'Helvetica Neue'.', Helvetica, sans-serif; text-decoration: none;">Restablecer su contraseña</a>
                                        </td>
                                      </tr>
                                    </table>
                                  </td>
                        ...
                        <p style="box-sizing: border-box; color: #74787E; font-family: Arial, '.'Helvetica Neue'.', Helvetica, sans-serif; font-size: 16px; line-height: 1.5em; margin-top: 0;" align="left">Si no solicitó un restablecimiento de contraseña, ignore este correo electrónico.</a></p>
                  ...
                  <table class="email-footer" align="center" width="570" cellpadding="0" cellspacing="0" style="box-sizing: border-box; font-family: Arial, '.'Helvetica Neue'.', Helvetica, sans-serif; margin: 0 auto; padding: 0; text-align: center; width: 570px;">
                    <tr>
                      <td class="content-cell" align="center" style="box-sizing: border-box; font-family: Arial, '.'Helvetica Neue'.', Helvetica, sans-serif; padding: 35px; word-break: break-word;">
                        <p class="sub align-center" style="box-sizing: border-box; color: #AEAEAE; font-family: Arial, '.'Helvetica Neue'.', Helvetica, sans-serif; font-size: 12px; line-height: 1.5em; margin-top: 0;" align="center">© 2017. All rights reserved.</p>
                        <p class="sub align-center" style="box-sizing: border-box; color: #AEAEAE; font-family: Arial, '.'Helvetica Neue'.', Helvetica, sans-serif; font-size: 12px; line-height: 1.5em; margin-top: 0;" align="center">
                          TRIUB CUEROS, BUENOS AIRES]
                          <br />CAPITAL FEDERAL
                          <br />CORRIENTES 1965 4 L
                        </p>
                      </td>
                    </tr>
                  </table>
